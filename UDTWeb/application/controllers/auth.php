...
class Auth extends CI_Controller
{
	...
	function send_again()
	{
		if (!$this->tank_auth->is_logged_in(FALSE)) {							// not logged in or activated
			...
			$this->abstract_view('auth/send_again_form', $data);
		}
	}
	...
	function forgot_password()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->abstract_view('auth/forgot_password_form', $data);
		}
	}
	...
	function reset_password()
	{
		...
		$this->abstract_view('auth/reset_password_form', $data);
	}
	...
	function change_password()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->abstract_view('auth/change_password_form', $data);
		}
	}
	...
	function change_email()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->abstract_view('auth/change_email_form', $data);
		}
	}
	...
	function unregister()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->abstract_view('auth/unregister_form', $data);
		}
	}
