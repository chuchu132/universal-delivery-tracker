...
<body  onload="MM_preloadImages('<?=base_url()?>images/btn_1_over.jpg','<?=base_url()?>images/btn_2_over.jpg','<?=base_url()?>images/btn_3_over.jpg','<?=base_url()?>images/btn_4_over.jpg','<?=base_url()?>images/btn_5_over.jpg', '<?=base_url()?>images/btn_6_over.jpg')">
...
<table width="775" height="700" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td width="59" height="651" rowspan="15">
			<img src="<?=base_url()?>images/main.jpg" width="59" height="651" alt="" /></td>
		...
		<td width="95" height="33" colspan="3" align="left" valign="top"><?php echo anchor('/auth/login/', 'Login'); ?></td>
		<td width="95" height="33" colspan="3" align="left" valign="top"><?php echo anchor('/auth/register/', 'Register'); ?></td>
		<td width="60" height="651" rowspan="15">
			<img src="<?=base_url()?>images/main-03.jpg" width="60" height="651" alt="" /></td>
	...
	<tr>
		...
		<td width="106" height="17" colspan="2" align="left" valign="top" bgcolor="#A7A7A7"><a href="index.html"><img src="<?=base_url()?>images/btn_1.jpg" alt="" name="btn_1" width="106" height="17" border="0" id="btn_1" onmouseover="MM_swapImage('btn_1','','<?=base_url()?>images/btn_1_over.jpg',1)" onmouseout="MM_swapImgRestore()"/></a></td>
		<td width="3" height="17" align="left" valign="top" bgcolor="#A7A7A7">
			<img src="<?=base_url()?>images/lines.jpg" width="3" height="17" alt="" /></td>
		<td width="100" height="17" colspan="5" align="left" valign="top" bgcolor="#A7A7A7"><a href="contentpage.html"><img src="<?=base_url()?>images/btn_2.jpg" alt="" name="btn_2" width="100" height="17" border="0" id="btn_2" onmouseover="MM_swapImage('btn_2','','<?=base_url()?>images/btn_2_over.jpg',1)" onmouseout="MM_swapImgRestore()"/></a></td>
		<td width="3" height="17" align="left" valign="top" bgcolor="#A7A7A7">
			<img src="<?=base_url()?>images/lines-07.jpg" width="3" height="17" alt="" /></td>
		<td width="98" height="17" align="left" valign="top" bgcolor="#A7A7A7"><a href="contentpage.html"><img src="<?=base_url()?>images/btn_3.jpg" alt="" name="btn_3" width="98" height="17" border="0" id="btn_3" onmouseover="MM_swapImage('btn_3','','<?=base_url()?>images/btn_3_over.jpg',1)" onmouseout="MM_swapImgRestore()"/></a></td>
		<td width="3" height="17" align="left" valign="top" bgcolor="#A7A7A7">
			<img src="<?=base_url()?>images/lines-09.jpg" width="3" height="17" alt="" /></td>
		<td width="107" height="17" colspan="3" align="left" valign="top" bgcolor="#A7A7A7"><a href="contentpage.html"><img src="<?=base_url()?>images/btn_4.jpg" alt="" name="btn_4" width="107" height="17" border="0" id="btn_4" onmouseover="MM_swapImage('btn_4','','<?=base_url()?>images/btn_4_over.jpg',1)" onmouseout="MM_swapImgRestore()"/></a></td>
		<td width="3" height="17" align="left" valign="top" bgcolor="#A7A7A7">
			<img src="<?=base_url()?>images/lines-11.jpg" width="3" height="17" alt="" /></td>
		<td width="97" height="17" colspan="3" align="left" valign="top" bgcolor="#A7A7A7"><a href="contentpage.html"><img src="<?=base_url()?>images/btn_5.jpg" alt="" name="btn_5" width="97" height="17" border="0" id="btn_5" onmouseover="MM_swapImage('btn_5','','<?=base_url()?>images/btn_5_over.jpg',1)" onmouseout="MM_swapImgRestore()"/></a></td>
		<td width="3" height="17" align="left" valign="top" bgcolor="#A7A7A7">
			<img src="<?=base_url()?>images/lines-13.jpg" width="3" height="17" alt="" /></td>
		<td width="93" height="17" colspan="3" align="left" valign="top" bgcolor="#A7A7A7"><a href="contentpage.html"><img src="<?=base_url()?>images/btn_6.jpg" alt="" name="btn_6" width="93" height="17" border="0" id="btn_6" onmouseover="MM_swapImage('btn_6','','<?=base_url()?>images/btn_6_over.jpg',1)" onmouseout="MM_swapImgRestore()"/></a></td>
	...
	<tr>
		<td width="656" height="240" colspan="25" align="left" valign="top">
			<img src="<?=base_url()?>images/main-15.jpg" width="656" height="240" alt="" /></td>
	...
	<tr>
		...
		<td width="209" height="43" colspan="8" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/welcome.jpg" width="209" height="43" alt="" /></td>
		...
		<td width="185" height="43" colspan="8" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/news.jpg" width="185" height="43" alt="" /></td>
	...
	<tr>
		<td width="121" height="82" colspan="5" rowspan="2" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/welcome-18.jpg" width="121" height="82" alt="" /></td>
...
Nam eu nulla. Donec lobortis purus vel urna. Nunc laoreet lacinia nunc. In volutpat sodales ipsum. Sed vestibulum. <a href="#" class="a">Integer in ante. Sed posuere ligula</a> rhoncus erat. Fusce urna dui, sollicitudin ac, pulvinar quis</td>
		<td width="21" height="56" colspan="4" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/news-19.jpg" width="21" height="56" alt="" /></td>
	...
	<tr>
		<td width="21" height="55" colspan="4" rowspan="3" align="left" valign="top" bgcolor="#EFEFEF"><img src="<?=base_url()?>images/news-20.jpg" width="21" height="55" alt="" /></td>
	...
	<tr>
		<td width="162" height="40" colspan="7" rowspan="2" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/services.jpg" width="162" height="40" alt="" /></td>
	...
	<tr>
		<td width="185" height="45" colspan="8" rowspan="2" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/spotlight.jpg" width="185" height="45" alt="" /></td>
		<td width="0" height="23" nowrap></td>
	</tr>
	<tr>
		<td width="121" height="80" colspan="5" rowspan="2" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/services-23.jpg" width="121" height="80" alt="" /></td>
	...
	<tr>
		<td width="16" height="115" colspan="3" rowspan="2" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/spotlight-24.jpg" width="16" height="115" alt="" /></td>
...
l<a href="#" class="b">aoreet. magna. sagittis. Fusce elit</a></td>
	...
	<tr>
		<td width="27" height="57" colspan="2" align="left" valign="top" bgcolor="#EFEFEF">
			<img src="<?=base_url()?>images/services-25.jpg" width="27" height="57" alt="" /></td>
	...
	<tr>
		<td width="775" height="49" colspan="27" align="center" valign="middle" class="text2" style="background:url(<?=base_url()?>images/b_footer.jpg)"><a href="index.html">HOME</a> | <a href="contentpage.html">ABOUT US</a> | <a href="contentpage.html">SERVICES</a> | <a href="contentpage.html">SOLUTIONS</a> | <a href="contentpage.html">SUPPORT</a> | <a href="contentpage.html">CONTACTS</a><br />
